...
router.post(
  '/',
  validateRequest(ManagementDepartmentValidation.createManagementDapartmentZodSchema),
...
router.patch(
  '/:id',
  validateRequest(ManagementDepartmentValidation.updateManagementDapartmentZodSchema),
  auth(ENUM_USER_ROLE.SUPER_ADMIN, ENUM_USER_ROLE.ADMIN),
